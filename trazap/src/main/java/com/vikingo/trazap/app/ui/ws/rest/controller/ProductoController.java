...
public class ProductoController {
	...
	public ResponseEntity<ResponseServiceObject> updateBodega(@PathVariable int idProducto, @RequestBody ProductoRequest productoRequest){
	...
	public ResponseEntity<ResponseServiceObject> createBodega(@RequestBody ProductoRequest productoRequest){
	...
	public ResponseEntity<ResponseServiceObject> getBodegas(@PathVariable Integer idProducto) throws ServiceException {
