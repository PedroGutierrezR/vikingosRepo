					...
					},
					{
						...
						formatter: function(value, row, index) {
							...
							return [
								...
								"</a>  ",
								"<a class='remove' href='#'data-toggle='modal' data-target='#modalEliminarProveedor' onclick='onClickEliminar(\"" + row.idProveedor + "\");' title='Eliminar'>",
