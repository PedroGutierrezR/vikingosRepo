							...
							<div class=form-row>
								<div class="col-md-4 mb-3">
									<div class="form-group">
										...
										<div class="form-inline">
											<input type="text" class="form-control" id="idTxtTitulo"
								...
								<div class="col-md-4 mb-3">
									<div class="form-group">
										...
										<div class="form-inline">
											<input type="number" class="form-control" id="idTxtAnio"
								...
								<div class="col-md-4 mb-3">
									<div class="form-group">
										...
										<div class="form-inline">
											<input type="text" class="form-control" id="idTxtAutor"
												placeholder="Ingrese Autor" required>
											<div class="valid-feedback">Correcto!</div>
											<div class="invalid-feedback">Debe ingresar una
												descripción válida</div>
										</div>
								...
								<div class="col-md-4 mb-3">
									<div class="form-group">
										...
										<div class="form-inline">
											<input type="text" class="form-control" id="idTxtImprenta"
												placeholder="Ingrese Imprenta" required>
											<div class="valid-feedback">Correcto!</div>
											<div class="invalid-feedback">Debe ingresar una
												descripción válida</div>
										</div>
