...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<script>
    	let profesorDtoJson = '<%= request.getAttribute("profesorDtoJson") %>';
	</script>
...
<body>
	<table class="table table-hover" id="tblListaProfesores">
	</table>
		...
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
						data-dismiss="modal">Cerrar</button>
					<button type="button" class="btn btn-primary" id=idBtnEditarProfesor>Enviar</button>
				</div>
			</div>
		</div>
	</div>

	<!-- Modal Eliminar Porfesor-->
		...
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body text-center">
					<h2>¿Está seguro de eliminar al profesor?</h2>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
						data-dismiss="modal">Cerrar</button>
					<button type="button" class="btn btn-primary" id=idBtnEliminarProfesor>Eliminar</button>
				</div>
			</div>
		</div>
	</div>
