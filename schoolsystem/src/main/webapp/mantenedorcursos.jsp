				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu"
							...
							<a class="dropdown-item" id="idMenuMantenedorAlumno"
								href="/schoolsystem/mantenedoralumnos.srv">Mantenedor de alumnos</a>
						</div></li>
					<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#"
						id="navbarDropdownMenuLink" data-toggle="dropdown"
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu"
							aria-labelledby="navbarDropdownMenuLink">
							<a class="dropdown-item" id="idMenuMantenedorCursos" href="mantenedorcursos.jsp">Mantenedor de cursos</a> <a class="dropdown-item"
								id="idMenuMantenedorAsignaturas" href="#">Mantenedor de	asignaturas</a>
						</div></li>
				</ul>
			</div>
